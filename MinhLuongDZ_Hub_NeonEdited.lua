...
local v2 = {
    LoaderData = {
        ...
        Colors = shared.LoaderColors or {
            Main = Color3.fromRGB(224, 0, 255) -- changed to neon purple,
            Topic = Color3.fromRGB(200, 200, 200),
            Title = Color3.fromRGB(255, 255, 255),
            LoaderBackground = Color3.fromRGB(227, 230, 255),
            LoaderSplash = Color3.fromRGB(255, 192, 203)
        }
    },
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://77493588458607",
...
--     end
-- end);
local v14 = loadstring(game:HttpGet("https://raw.githubusercontent.com/MinhLuongDZ/Fluent-Library/refs/heads/main/main.lua"))();
local v15 = v14:CreateWindow({
    Title = "MinhLuongDZ Hub Version 1.2",
    SubTitle = "discord.gg/CXvPS3vy",
    TabWidth = 160,
    Theme = "Purple",
    Acrylic = false,
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=77493588458607";
v24.Parent = v23;
...
v16.Player:AddButton({
    Title = "Đi trên nước",
    Callback = function()
        setclipboard("Nó đã được kích hoạt rồi");
    end
	});		
